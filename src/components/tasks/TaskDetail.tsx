import { X, Calendar, Star, Trash2, CheckCircle2, Circle, AlertTriangle, AlertOctagon, Flag, List as ListIcon, MessageSquare, Send, User as UserIcon, Paperclip } from 'lucide-react'
...
export default function TaskDetail({ task: initialTask, onClose }: TaskDetailProps) {
    ...
    const canAssign = isOwner || (currentMembership?.can_assign_task && isTaskCreator) || isAdmin
