...
async function getAppliedMigrations(connection: oracledb.Connection): Promise<number[]> {
    try {
...
async function runMigration(connection: oracledb.Connection, migration: Migration): Promise<void> {
